...
public class HelpWindow extends JDialog {
    ...
    private static String htmlPT() {
        return "<html><head>" + CSS + "</head><body>"
            ...
            + "<h3>Duplo Clique &mdash; Detalhes Completos</h3>"
            + "<p>Clique duas vezes em qualquer linha para abrir um di&aacute;logo com o conte&uacute;do completo da coluna <i>Details</i>. &Uacute;til quando o texto &eacute; longo.</p>"
    ...
    private static String htmlEN() {
        return "<html><head>" + CSS + "</head><body>"
            ...
            + "<h3>Double-Click &mdash; Full Details</h3>"
            + "<p>Double-click any row to open a dialog with the complete content of the <i>Details</i> column &mdash; useful for long texts.</p>"
            + "<h3>Export to CSV</h3>"
